...
LOAD DATA INFILE '/datasets/source_crm/cust_info.csv' 
IGNORE INTO TABLE bronze_dev.crm_cust_info
...
LOAD DATA INFILE '/datasets/source_crm/prd_info.csv' 
IGNORE INTO TABLE bronze_dev.crm_prd_info
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
...
LOAD DATA INFILE '/datasets/source_crm/sales_details.csv' 
IGNORE INTO TABLE bronze_dev.crm_sales_details
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
...
LOAD DATA INFILE '/datasets/source_erp/CUST_AZ12.csv' 
IGNORE INTO TABLE bronze_dev.erp_cust_az12
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
...
LOAD DATA INFILE '/datasets/source_erp/LOC_A101.csv' 
IGNORE INTO TABLE bronze_dev.erp_loc_a101
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
...
LOAD DATA INFILE '/datasets/source_erp/PX_CAT_G1V2.csv' 
IGNORE INTO TABLE bronze_dev.erp_px_cat_g1v2
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
